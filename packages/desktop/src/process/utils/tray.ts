...
import { createBrandTrayImage } from '@/branding/trayIcon';
...
const getTrayIcon = (): Electron.NativeImage => {
  ...
  const branded = createBrandTrayImage(nativeImage, resourcesPath, process.platform) as Electron.NativeImage | null;
