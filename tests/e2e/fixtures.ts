 ...
 *      (e.g. out/linux-unpacked/nexwork, out/mac-arm64/NexWork.app, out/win-unpacked/NexWork.exe).
...
function resolvePackagedApp(): { executablePath: string; cwd: string } | null {
  ...
  if (platform === 'win32') {
    // out/win-unpacked/NexWork.exe  or  out/win-x64-unpacked/NexWork.exe
    ...
    // out/mac-arm64/NexWork.app/Contents/MacOS/NexWork  or  out/mac/NexWork.app/...
    ...
    // Linux: out/linux-unpacked/nexwork  (lowercase executable name)
