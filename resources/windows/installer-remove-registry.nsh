...
!macro customRemoveFiles
  ...
  ${if} $AionUiRemoveDirResult != 0
    ...
    ${if} $AionUiAtomicRemoveSucceeded == "1"
      ...
      DetailPrint `NexWork previous installation had locked residual files; continuing after atomic cleanup succeeded: $INSTDIR`
